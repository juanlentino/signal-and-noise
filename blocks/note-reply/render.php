<?php
/**
 * Dynamic render for signal-noise/note-reply: wpautop( [shortcode] ), the string
...
echo sn_php_block_output( sn_note_reply_shortcode(), __( 'Reply by email', 'signal-and-noise' ) );
