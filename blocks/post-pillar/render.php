<?php
/**
 * Dynamic render for signal-noise/post-pillar: wpautop( [shortcode] ), the string
...
echo sn_php_block_output( sn_post_pillar_shortcode(), __( 'Pillar link', 'signal-and-noise' ) );
