...
- **Speculative loading** raised to prerender/moderate (`inc/speculation.php`); `/notes/page/*` excluded. Search needs no entry: core already excludes every query-string URL under pretty permalinks.
