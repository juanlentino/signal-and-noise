<?php
/**
 * Tests for tools/cron-liveness.php — does the scheduled parity workflow (this repo's fires at 07:20 UTC,
 * offset from the plugin repo's 07:00 so the two never report at the same instant) show
 * signs of life?
 *
 ...
 * @since theme CI (unversioned — dev/CI tooling, nothing ships)
 */
