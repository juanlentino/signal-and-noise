...
| 8 | *Optional* feature minors — ✅ **v4.7.0 admin-bar SHIPPED 2026-06-06** (`af4900b`); v4.8.0 post-editor consolidation = FUZZY stub, needs brainstorm; + frontier picks below | both | v4.7.0 done | partially shipped | M |
